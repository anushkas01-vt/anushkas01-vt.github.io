...
class MarkovChain:
    ...
    def save_kwargs(self, **kwargs):
        ...
        # Colors
        self.arrow_facecolor = self.kwargs.get("arrow_facecolor", '#86eb34')
        self.arrow_edgecolor = self.kwargs.get("arrow_edgecolor", '#d934eb')
        self.node_facecolor = self.kwargs.get("node_facecolor", '#2693de')
        self.node_edgecolor = self.kwargs.get("node_edgecolor", '#e6ecf7')
